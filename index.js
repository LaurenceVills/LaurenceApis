...
const settings = {
  name: "Laurence Api",
  description: "Laurence Api is a simple and lightweight REST API built with Next.js, designed to provide easy access to various web functionalities.",
  apiSettings: { creator: "Laurence" },
  linkWhatsapp: "https://t.me/Azurajah",
  linkChannel: "https://whatsapp.com/channel/0029VbBkxGLJpe8k28Wxxs34", 
  linkGithub: "https://github.com/LaurenceVills", 
...
app.use((req, res, next) => {
  ...
  res.json = function (data) {
    if (data && typeof data === 'object') {
      const responseData = { status: data.status, creator: settings.apiSettings.creator || "Created Using Laurence", ...data };
...
// Endpoint untuk mendapatkan data API dalam format baru
